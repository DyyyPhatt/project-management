...
const ProjectHeader = ({ activeTab, setActiveTab, onDelete }: Props) => {
        ...
        <Header
          ...
          buttonComponent={
            <div className="flex gap-2">
              ...
              <button
                onClick={onDelete}
                className="flex items-center rounded-md border border-red-500 px-3 py-2 text-red-500 hover:bg-red-100 dark:hover:bg-red-950"
              >
